...
public class AccessListOfSports {
	...
	public AccessListOfSports(Connection connection) {
		this.connection = connection;
	}

	public ArrayList<SportEntry> execute(String login) throws DataBaseException {
		try {
			...
			verufyAmISubscribed(login);

			return listSportEntry;
		} catch (Exception e) {
			e.printStackTrace();
	...
	private void verufyAmISubscribed(String login) throws DataBaseException {
		try {
			Statement statement = connection.createStatement();
			ResultSet resultSet = statement
